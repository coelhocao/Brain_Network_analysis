...
signed_louvain <- function(g, gamma = 1, weighted = T, comm = NULL, B = NULL,
                        mod = c(NULL, 'modularity', 'potts', 'neg_sym', 'neg_asym')) {
  ...
  #
  # OUTPUT: List(
  #         membership, community affiliation vector
  #         modularity, optimized community-structure statistic (modularity by default)
  #         names,      chr vector with node names
  ...
  l <- structure(l, class = 'communities')  # To fit in other functions from igraph
  return(l)
}
